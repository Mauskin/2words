// Run in Terminal
// $ /System/Library/Frameworks/JavaScriptCore.framework/Versions/Current/Resources/jsc Documents/numwords.js

var max = 999;
var mLen = (max+"").length;

for (var i = 0; i <= max; i++) debug( "      ".substr(1, mLen - (i+"").length) + i + ": " + numWords(i) + "." );
...
function numWords( num ){
	...
	var hundreds    = [, "сто",        "двести",     "триста",     "четыреста",    "пятьсот",    "шестьсот",    "семьсот",    "восемьсот",    "девятсот"     ];
